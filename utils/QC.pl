...
foreach my $file (@files) {
    ...
    if (-e $file2) {
        ...
        `java -jar $DIR/../third-party/trimmomatic-0.32.jar SE -threads 30 $file1 $sample.clean_1.fq ILLUMINACLIP:$adaptor:2:30:10 LEADING:20 TRAILING:20 SLIDINGWINDOW:4:25 MINLEN:18 TOPHRED33`;
    }
    `rm $sample.rm*_*.fq`;
