...
my @result_p = "";
my $header   = <IN>;
$header = "chr\tpos\t\tdad\tmom\tson\tM1M1\tM1M2\tP1P1\tP1P2\tM1P1\tM1/M2\tP1/P2\n";
print "$header";
        ...
        if ( $line_count >= 1 ) {
            ...
            foreach $each_mom (@mom) {
                    ...
                    or $line[$mom] eq 'F' )
                {
                    ...
                    $hashmom{ $line[ $mom - 1 ] . '_' . $mom_var[0] } =
                      $mom_var[1];
                    $sum_mom      += $mom_var[1];
            ...
            foreach $each_son (@son) {
                    ...
                    or $line[$son] eq 'F' )
                {
                    ...
                    $hashson{ $line[ $son - 1 ] . '_' . $son_var[0] } =
                      $son_var[1];
            ...
            #@son_var3 = @son_var1;
            $hash{ M1 . '_' . $son_var1[0] . '|' . M1 . '_' . $son_var1[1] } =
              1;
            $hash{ M1 . '_' . $son_var1[0] . '|' . M2 . '_' . $son_var1[1] } =
              1;
            $hash{ M1 . '_' . $son_var1[0] . '|' . P1 . '_' . $son_var1[1] } =
              1;
            $hash{ M1 . '_' . $son_var1[0] . '|' . P2 . '_' . $son_var1[1] } =
              1;
            $hash{ M2 . '_' . $son_var1[0] . '|' . M1 . '_' . $son_var1[1] } =
              1;
            $hash{ M2 . '_' . $son_var1[0] . '|' . M2 . '_' . $son_var1[1] } =
              1;
            $hash{ M2 . '_' . $son_var1[0] . '|' . P1 . '_' . $son_var1[1] } =
              1;
            $hash{ M2 . '_' . $son_var1[0] . '|' . P2 . '_' . $son_var1[1] } =
              1;
            $hash{ P1 . '_' . $son_var1[0] . '|' . M1 . '_' . $son_var1[1] } =
              1;
            $hash{ P1 . '_' . $son_var1[0] . '|' . M2 . '_' . $son_var1[1] } =
              1;
            $hash{ P1 . '_' . $son_var1[0] . '|' . P1 . '_' . $son_var1[1] } =
              1;
            $hash{ P1 . '_' . $son_var1[0] . '|' . P2 . '_' . $son_var1[1] } =
              1;
            $hash{ P2 . '_' . $son_var1[0] . '|' . M1 . '_' . $son_var1[1] } =
              1;
            $hash{ P2 . '_' . $son_var1[0] . '|' . M2 . '_' . $son_var1[1] } =
              1;
            $hash{ P2 . '_' . $son_var1[0] . '|' . P1 . '_' . $son_var1[1] } =
              1;
            $hash{ P2 . '_' . $son_var1[0] . '|' . P2 . '_' . $son_var1[1] } =
              1;
            @son_var1 = "";
            ...
            foreach $each_dad (@dad) {
                    ...
                    or $line[$dad] eq 'F' )
                {
                    ...
                    $hashdad{ $line[ $dad - 1 ] . '_' . $dad_var[0] } =
                      $dad_var[1];
            ...
            if (    $sum_dad > 100
                and $sum_mom >= 100
                and $sum_son > 100
                and $sum_dad_rate > 0.6
                and $sum_mom_rate > 0.6 )
            {
                $hash4{$chr}++;
                foreach ( keys %hash ) {
                    if ( exists $hash1{$_} ) {
                ...
                #push @chr_result, "$ran\t$len{$line[0]}\t$len1{$len{$line[0]}}\t$dad_var1_type\t$mom_var1_type\t$son_var3_type\t";
                @son_var3 = "";
                @mom_var3 = "";
                @dad_var3 = "";
                ...
                if (   exists( $hash3{M1P1} )
                    or exists( $hash3{M1P2} )
                    or exists( $hash3{M2P1} )
                    or exists( $hash3{M2P2} )
                    or exists( $hash3{P1M1} )
                    or exists( $hash3{P1M2} )
                    or exists( $hash3{P2M1} )
                    or exists( $hash3{P2M2} ) )
                {
                    push @result_p, "YES";
                    $hash5{ $chr . '_' . M1P1 }++;
                }
                if (    !exists( $hash3{M1P1} )
                    and !exists( $hash3{M1P2} )
                    and !exists( $hash3{M2P1} )
                    and !exists( $hash3{M2P2} )
                    and !exists( $hash3{P1M1} )
                    and !exists( $hash3{P1M2} )
                    and !exists( $hash3{P2M1} )
                    and !exists( $hash3{P2M2} ) )
                {
                    push @result_p, "NO";
                }
                if ( exists( $hash3{M1M1} ) or exists( $hash3{M2M2} ) ) {
...
$header1 = "chr\tnum\tLOH poss\tM1M1\tM1M2\tM1P1\tP1P1\tP1P2\tM1/M2\tP1/P2\n";
print "$header1";
foreach $chr1 (
    sort { ( split /D/, $a )[1] <=> ( split /D/, $b )[1] }
    keys %hash4
  )
{
    if ( $chr1 ne "" and $chr1 ne "DX" and $hash4{$chr1} >0 ) {
        $chr_2 = $chr1;
        $chr_2 =~ s/D/Chr/;
        ...
        ##添加判断染色体是否为单亲二倍体
        $hashdouble{$chr1.'_'.M1M1} = $rate1;
        $hashdouble{$chr1.'_'.M1P1} = $rate3;
        $hashdouble{$chr1.'_'.P1P1} = $rate4;
        @possibility = ($rate1,$rate4);
        $maxposs = max @possibility;
        $maxposs =~ s/\%//;
        foreach (keys %hashdouble){
          if ($hashdouble{$_} == $maxposs.'%' and $maxposs > 90){
            $chrdoubleposs = $_.'('.$hashdouble{$_}.')';
            %hashdouble = ();
            last;
          }
          else{
        ...
        print "$chrdoubleposs\t$rate1\t$rate2\t$rate3\t$rate4\t$rate5\t$rate1\t$rate4\n";
    }
    elsif($hash4{$chr1} ==0) {
        next;
    }
        ...
        $hashdouble{$chr1.'_'.M1P1} = $rate3;
        $hashdouble{$chr1.'_'.P1P1} = $rate4;
        @possibilityDX = ($rate1,$rate3,$rate4);
        $maxposs = max @possibilityDX;
        $maxposs =~ s/\%//;
        foreach (keys %hashdouble){
          if (($hashdouble{$_} == $maxposs.'%' and $_ =~ 'M1M1') or($hashdouble{$_} == $maxposs.'%' and $_ =~ 'M1P1')){
            $chrdoublepossDX = $_.'('.$hashdouble{$_}.')normal';
            %hashdouble = ();
            last;
          }
          else{
            $chrdoublepossDX = 'abnormal';
          }
        }
        $chrX  = "ChrX\t$hash4{$chr1}\t$chrdoublepossDX\t$rate1\t$rate2\t$rate3\t$rate4\t$rate5\t$rate1\t$rate4\n";
    }
}
...
$paternityposs = $rate_M1P1 ;
$paternityposs =~ s/\%//;
if ($paternityposs <= 95){
  $rate_M1P1 = $rate_M1P1.'(abnormal)';
}
else{
  $rate_M1P1 = $rate_M1P1.'(normal)';
}
