...
parser.add_argument("-s2", "--son", required=True, type=int, help="son2 column num in input file")
...
for i in I:
	...
	if i == 1:
		...
		a += 1
finalOut = (str(float(a)/len(I)), str(P_T), str(len(pos_hmm)), str(E), str(e))

outResults2 = '\t'.join(finalOut)

with open(outFile1, 'w') as file1:
        
        file1.write(outResults1+"\n")
	file1.write(outResults2)
