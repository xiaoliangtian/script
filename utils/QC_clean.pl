...
foreach my $file (@files) {
    ...
    if (-e $file2) {
        ...
        `java -jar $DIR/../third-party/trimmomatic-0.32.jar PE -threads 30 $file1 $file2 $sample.clean_1.fq $sample.rm_1.fq $sample.clean_2.fq $sample.rm_2.fq ILLUMINACLIP:$adaptor:2:30:10 LEADING:20 TRAILING:20 SLIDINGWINDOW:4:20 MINLEN:50  TOPHRED33`;
    }else {
