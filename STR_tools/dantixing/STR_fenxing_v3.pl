...
my $header = <IN>;
print
"pos\tdad_genotype\tdad_frequency\tmom_genotype\tmom_frequency\tson_genotype\tson_frequency\tson_from_dm\tson_from_dm%\tsum_dm\tson_from_dad\tson_from_dad%\tsum_dad\tson_from_mom\tson_from_mom%\tsum_mom\tson_off_dm\tson_off_dm\tsum_off_dm\n";
...
while (<IN>) {
	...
	if ( $line[0] =~ /^\D[0-9]+/ ) {
		...
		$ran = $chr;
                ...
                $dad_var1 =~ s/\([A-Z]+\)//g;
                $chr_result = 
"$ran\t$len{$line[0]}\t$len1{$len{$line[0]}}\t$dad_var1\t$dad_var2\t$mom_var1\t$mom_var2\t$son_var1\t$son_var2\t$son_from_dm\t$son_from_dm1\t$sum_son_from_dm1\t$son_from_dad\t$son_from_dad1\t$sum_son_from_dad1\t$son_from_mom\t$son_from_mom1\t$sum_son_from_mom1\t$son_off_dm\t$son_off_dm1\t$sum_son_off_dm1";
