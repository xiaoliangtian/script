...
perl /mnt/workshop/SC/project/WGS/180726-txl_180725_NB502022_0051_AH5YCYAFXY/CNV/pos2qu.pl $1.result > $1.band
awk '{print $2":"$3"-"$4}' $1.result > $1.intervals
...
paste $1.band $1.intervals.result > $1.band_gene.xls
