        ...
        if ( $line_count >= 1 ) {
            ...
            if ( $sum_mom > 50 ) {
                foreach $mom_type ( keys %hashmom ) {
                    ...
                    if ( $mom_type_rate > 0.1 and $mom_type_rate <= 0.15 ) {
                        $ten++;
                    }
                    if ( $mom_type_rate > 0.15 and $mom_type_rate <= 0.2 ) {
                        $fifteen++;
                    }
                    if ( $mom_type_rate > 0.2 and $mom_type_rate <= 0.25 ) {
                        $twenty++;
                    }
                    if ( $mom_type_rate > 0.25 and $mom_type_rate <= 0.3 ) {
                        $twentyFive++;
                    }
                    if ( $mom_type_rate > 0.3 and $mom_type_rate <= 0.35 ) {
                        $thirty++;
                    }
                    if ( $mom_type_rate > 0.35 and $mom_type_rate <= 0.4 ) {
                        $thirtyFive++;
                    }
                    if ( $mom_type_rate > 0.4 and $mom_type_rate <= 0.45 ) {
                        $fourty++;
                    }
                    if ( $mom_type_rate > 0.45 and $mom_type_rate <= 0.5 ) {
                        $fourtyFive++;
                    }
                    if ( $mom_type_rate > 0.5 and $mom_type_rate <= 0.55 ) {
                        $fifty++;
                    }
                    if ( $mom_type_rate > 0.55 and $mom_type_rate <= 0.6 ) {
                        $fiftyFive++;
                    }
                    if ( $mom_type_rate > 0.6 and $mom_type_rate <= 0.65 ) {
                        $sixty++;
                    }
                    if ( $mom_type_rate > 0.65 and $mom_type_rate <= 0.7 ) {
                        $sixtyFive++;
                    }
                    if ( $mom_type_rate > 0.7 and $mom_type_rate <= 0.75 ) {
                        $seventy++;
                    }
                    if ( $mom_type_rate > 0.75 and $mom_type_rate <= 0.8 ) {
                        $seventyFive++;
                    }
                    if ( $mom_type_rate > 0.8 and $mom_type_rate <= 0.85 ) {
                        $eighty++;
                    }
                    if ( $mom_type_rate > 0.85 and $mom_type_rate <= 0.9 ) {
                        $eightyFive++;
                    }
                    if ( $mom_type_rate > 0.9 and $mom_type_rate <= 0.95 ) {
                        $ninety++;
                    }
