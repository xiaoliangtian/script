...
if [ $2 == '1M' ];then 
	...
	cnvkit.py batch $1.dedup.sorted.bam -r  /home/tianxl/pipeline/CNV-seq/GDCNV-seq/nextSeq500ref/1M/my_reference_1Mnext500.cnn   -d analyse/ -p 10 
elif [ $2 == '100K' ];then
        mkdir  -p  analyse
        mkdir  -p  100K/result
        cp result/Mapping/Mapping.xls 100K/
        cnvkit.py batch $1.dedup.sorted.bam -r  /home/tianxl/pipeline/CNV-seq/GDCNV-seq/nextSeq500ref/100K/my_reference_25Knext500.cnn   -d analyse/ -p 10
	...
	perl /home/tianxl/pipeline/CNV-seq/cnvkit2type_v2.pl $1.dedup.sorted.cns $1.type $1.qianhe > $1.cnv
        ...
        cd ../ 
        sh /home/tianxl/pipeline/CNV-seq/GDCNV-seq/GDpip_next500.sh $1 $2 
      fi 
