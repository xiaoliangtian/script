...
def get_B(Si):
	...
	for t, item in enumerate(Si):
		...
		k = round(int(item[5])/5)

		n = round((int(item[4]) + int(item[5]))/5)
		...
		binom0 = stats.binom.pmf(k, n, prob0)

		binom1 = stats.binom.pmf(k, n, prob1)

       		print(Si[t], prob0, prob1, n, k, binom0, binom1)

		P_hap0 = binom0/(binom0+binom1)

		P_hap1 = binom1/(binom0+binom1)
