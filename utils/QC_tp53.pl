...
foreach my $file (@files) {
    ...
    if (-e $file2) {
        ...
        `java -jar $DIR/../third-party/trimmomatic-0.32.jar PE -threads 30 $file1 $file2 $sample.clean_1.fq $sample.rm_1.fq $sample.clean_2.fq $sample.rm_2.fq ILLUMINACLIP:$adaptor1:2:30:10 LEADING:20 TRAILING:20 SLIDINGWINDOW:4:15 MINLEN:36   TOPHRED33`;
    }else {
        `java -jar $DIR/../third-party/trimmomatic-0.32.jar SE -threads 30 $file1 $sample.clean_1.fq ILLUMINACLIP:$adaptor1:2:30:10 LEADING:20 TRAILING:20 SLIDINGWINDOW:4:13 MINLEN:$minlen TOPHRED33`;
    }
    #`rm $sample.rm*_*.fq`;
...
USAGE:
    ...
    [-a ADAPTER]     = ADAPTER file.Default = $DIR/adapter1.fa
