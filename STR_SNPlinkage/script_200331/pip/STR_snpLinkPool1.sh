...
for i in `cat list`; do 
 { read -u6
   { sleep 1
     ...
     perl /home/tianxl/pipeline/STR_SNPlinkage/script_200331/pip/STRfq2needfq_Pool1_v3.pl $i*R1.fastq.gz $i*R2.fastq.gz all "$i"_R1.fastq "$i"_R2.fastq $i > analyse/$i.R1.fastq
     mkdir SNP
     cd analyse
     ...
     perl /home/tianxl/pipeline/STR_SNPlinkage/script_200331/pip/STRlociFq2STRgenoFq.pl $i.R1.fastq /home/tianxl/pipeline/STR_SNPlinkage/script_200331/database/STR43Loci_genotype.database /home/tianxl/pipeline/STR_SNPlinkage/script_200331/database/STR46Loci_ref.list /home/tianxl/pipeline/STR_SNPlinkage/script_200331/database/STR_match.database $i.nomatch.list > $i.need.fastq
     ...
     perl /home/tianxl/pipeline/STR_SNPlinkage/script_200331/pip/STRsamStat.pl $i.sam  $i.type >$i.samStat.log
