...
my %hashrate = ();
#$header =~s/\n//;
$header = "chr\tpos\t\tF\tM\tS\t" . 'M1M1M1' . "\t" . "M1M1M2\tM1M1P1\tM1M2P1\tP1P1P1\tP1P1P2\tP1P1M1\tP1P2M1\tMMM\tMMP\tPPP\tPPM\n";
print "$header";
while (<IN>) {
    chomp;
    $line = $_;
    ...
    if ( substr( $line, 0, 2 ) ne "##" ) {
        ...
        ###添加三体倍型判断（2：1）
          ...
          $chrome = $line[$#line-1];
          $chrome =~ s/D/Chr/;
          $hashrate{$chrome} = $line[$#line];
          # print "$chrome\t$hashrate{$chrome}\n";
        }
        else {
            next;
        }
        ...
        if ( $line_count >= 1 ) {
            ...
            if ( $sum_dad >= 100 and $sum_mom >= 100 and $sum_son > 100 and $sum_dad_rate > 0.6 and $sum_mom_rate > 0.6 ) {
                ...
                if (   exists $hash3{M1M1M2}
                    or exists $hash3{M1M2M1}
                    or exists $hash3{M1M2M2}
                    or exists $hash3{M2M1M1}
                    or exists $hash3{M2M1M2}
                    or exists $hash3{M2M2M1} )
                {
                    push @result_p, "YES";
                    $hash5{ $chr . '_' . M1M1M2 }++;
                }
                if (    !exists $hash3{M1M1M2}
                    and !exists $hash3{M1M2M1}
                    and !exists $hash3{M1M2M2}
                    and !exists $hash3{M2M1M1}
                    and !exists $hash3{M2M1M2}
                    and !exists $hash3{M2M2M1} )
                {
                    push @result_p, "NO";
                }
                if (   exists $hash3{M1M1P1}
                    or exists $hash3{M1M1P2}
                    or exists $hash3{M1P1M1}
                    or exists $hash3{M1P2M1}
                    or exists $hash3{M2M2P1}
                    or exists $hash3{M2M2P2}
                    or exists $hash3{M2P1M2}
                    or exists $hash3{M2P2M2}
                    or exists $hash3{P1M1M1}
                    or exists $hash3{P1M2M2}
                    or exists $hash3{P2M1M1}
                    or exists $hash3{P2M2M2} )
                {
                    push @result_p, "YES";
                    $hash5{ $chr . '_' . M1M1P1 }++;
                }
                if (    !exists $hash3{M1M1P1}
                    and !exists $hash3{M1M1P2}
                    and !exists $hash3{M1P1M1}
                    and !exists $hash3{M1P2M1}
                    and !exists $hash3{M2M2P1}
                    and !exists $hash3{M2M2P2}
                    and !exists $hash3{M2P1M2}
                    and !exists $hash3{M2P2M2}
                    and !exists $hash3{P1M1M1}
                    and !exists $hash3{P1M2M2}
                    and !exists $hash3{P2M1M1}
                    and !exists $hash3{P2M2M2} )
                {
                    push @result_p, "NO";
                }
                if (   exists $hash3{M1M2P1}
                    or exists $hash3{M1M2P2}
                    or exists $hash3{M1P1M2}
                    or exists $hash3{M1P2M2}
                    or exists $hash3{M2M1P1}
                    or exists $hash3{M2M1P2}
                    or exists $hash3{M2P1M1}
                    or exists $hash3{M2P2M1}
                    or exists $hash3{P1M1M2}
                    or exists $hash3{P1M2M1}
                    or exists $hash3{P2M1M2}
                    or exists $hash3{P2M2M1} )
                {
                    push @result_p, "YES";
                    $hash5{ $chr . '_' . M1M2P1 }++;
                }
                if (    !exists $hash3{M1M2P1}
                    and !exists $hash3{M1M2P2}
                    and !exists $hash3{M1P1M2}
                    and !exists $hash3{M1P2M2}
                    and !exists $hash3{M2M1P1}
                    and !exists $hash3{M2M1P2}
                    and !exists $hash3{M2P1M1}
                    and !exists $hash3{M2P2M1}
                    and !exists $hash3{P1M1M2}
                    and !exists $hash3{P1M2M1}
                    and !exists $hash3{P2M1M2}
                    and !exists $hash3{P2M2M1} )
                {
                    push @result_p, "NO";
                }
                if ( exists $hash3{P1P1P1} or exists $hash3{P2P2P2} ) {
                    push @result_p, "YES";
                    $hash5{ $chr . '_' . P1P1P1 }++;
                }
                if ( !exists $hash3{P1P1P1} and !exists $hash3{P2P2P2} ) {
                    push @result_p, "NO";
                }
                if (   exists $hash3{P1P1P2}
                    or exists $hash3{P1P2P1}
                    or exists $hash3{P1P2P2}
                    or exists $hash3{P2P1P1}
                    or exists $hash3{P2P1P2}
                    or exists $hash3{P2P2P1} )
                {
                    push @result_p, "YES";
                    $hash5{ $chr . '_' . P1P1P2 }++;
                }
                if (    !exists $hash3{P1P1P2}
                    and !exists $hash3{P1P2P1}
                    and !exists $hash3{P1P2P2}
                    and !exists $hash3{P2P1P1}
                    and !exists $hash3{P2P1P2}
                    and !exists $hash3{P2P2P1} )
                {
                    push @result_p, "NO";
                }
                if (   exists $hash3{M1P1P1}
                    or exists $hash3{M1P2P2}
                    or exists $hash3{M2P1P1}
                    or exists $hash3{M2P2P2}
                    or exists $hash3{P1M1P1}
                    or exists $hash3{P1M2P1}
                    or exists $hash3{P1P1M1}
                    or exists $hash3{P1P1M2}
                    or exists $hash3{P2M1P2}
                    or exists $hash3{P2M2P2}
                    or exists $hash3{P2P2M1}
                    or exists $hash3{P2P2M2} )
                {
                    push @result_p, "YES";
                    $hash5{ $chr . '_' . P1P1M1 }++;
                }
                if (    !exists $hash3{M1P1P1}
                    and !exists $hash3{M1P2P2}
                    and !exists $hash3{M2P1P1}
                    and !exists $hash3{M2P2P2}
                    and !exists $hash3{P1M1P1}
                    and !exists $hash3{P1M2P1}
                    and !exists $hash3{P1P1M1}
                    and !exists $hash3{P1P1M2}
                    and !exists $hash3{P2M1P2}
                    and !exists $hash3{P2M2P2}
                    and !exists $hash3{P2P2M1}
                    and !exists $hash3{P2P2M2} )
                {
                    push @result_p, "NO";
                }
                if (   exists $hash3{M1P1P2}
                    or exists $hash3{M1P2P1}
                    or exists $hash3{M2P1P2}
                    or exists $hash3{M2P2P1}
                    or exists $hash3{P1M1P2}
                    or exists $hash3{P1M2P2}
                    or exists $hash3{P1P2M1}
                    or exists $hash3{P1P2M2}
                    or exists $hash3{P2M1P1}
                    or exists $hash3{P2M2P1}
                    or exists $hash3{P2P1M1}
                    or exists $hash3{P2P1M2} )
                {
                    push @result_p, "YES";
                    $hash5{ $chr . '_' . P1P2M1 }++;
                }
                if (    !exists $hash3{M1P1P2}
                    and !exists $hash3{M1P2P1}
                    and !exists $hash3{M2P1P2}
                    and !exists $hash3{M2P2P1}
                    and !exists $hash3{P1M1P2}
                    and !exists $hash3{P1M2P2}
                    and !exists $hash3{P1P2M1}
                    and !exists $hash3{P1P2M2}
                    and !exists $hash3{P2M1P1}
                    and !exists $hash3{P2M2P1}
                    and !exists $hash3{P2P1M1}
                    and !exists $hash3{P2P1M2} )
                {
                    push @result_p, "NO";
                }
                if (   exists( $hash3{M1M1M1} )
                    or exists( $hash3{M2M2M2} )
                    or exists $hash3{M1M1M2}
                    or exists $hash3{M1M2M1}
                    or exists $hash3{M1M2M2}
                    or exists $hash3{M2M1M1}
                    or exists $hash3{M2M1M2}
                ...
                if (    !exists( $hash3{M1M1M1} )
                    and !exists( $hash3{M2M2M2} )
                    and !exists $hash3{M1M1M2}
                    and !exists $hash3{M1M2M1}
                    and !exists $hash3{M1M2M2}
                    and !exists $hash3{M2M1M1}
                    and !exists $hash3{M2M1M2}
                ...
                if (   exists $hash3{P1P1P1}
                    or exists $hash3{P1P2P2}
                    or exists $hash3{P1P1P2}
                    or exists $hash3{P1P2P1}
                    or exists $hash3{P1P2P2}
                    or exists $hash3{P2P1P1}
                    or exists $hash3{P2P1P2}
...
$header1 = "chr\tnum\t三体可能性(两种基因型比例（位点数））\tM1M1M1\tM1M1M2\tM1M1P1\tM1M2P1\tP1P1P1\tP1P1P2\tP1P1M1\tP1P2M1\tMMM\tMMP\tPPP\tPPM\n";
print "$header1";
foreach $chr1 ( sort { ( split /D/, $a )[1] <=> ( split /D/, $b )[1] } keys %hash4 ) {
    if ($hash4{$chr1} ==0) {
        next;
    }
    elsif ( $chr1 ne "" and $chr1 ne "DX" ) {
        $chr_2 = $chr1;
        $chr_2 =~ s/D/Chr/;
        ...
        ##添加判断染色体为三体的可能性的比例
        $hashtri{$chr1.'_'.MMM} = $rate9;
        $hashtri{$chr1.'_'.MMP} = $rate10;
        $hashtri{$chr1.'_'.PPP} = $rate11;
        $hashtri{$chr1.'_'.PPM} = $rate12;
        @possibility = ($rate1,$rate2,$rate3,$rate4,$rate5,$rate6,$rate7,$rate8,$rate9,$rate10,$rate11,$rate12);
        $maxposs = max @possibility;##print "$maxposs";
        $maxposs =~ s/\%//;
        foreach (keys %hashtri) {
          ##print "$_";
          if (($hashtri{$_} == $maxposs.'%') and ($maxposs > 90 )) {
            $Chrtriposs = "$_".'('.$maxposs.'%)';
            %hashtri = ();
            last;
          }         
          else{
        ...
        ##
        # print "$hashrate{$chr_2 }"."$chr_2";
        print "$Chrtriposs"."(".$hashrate{$chr_2}.")"."\t$rate1\t$rate2\t$rate3\t$rate4\t$rate5\t$rate6\t$rate7\t$rate8\t$rate9\t$rate10\t$rate11\t$rate12\n";
    }
    elsif ( $chr1 eq 'DX' ) {
        ...
        $hashtri{$chr1.'_'.PPP} = $rate11;
        $hashtri{$chr1.'_'.PPM} = $rate12;
        @possibilityDX = ($rate1,$rate2,$rate3,$rate4,$rate5,$rate6,$rate7,$rate8,$rate9,$rate10,$rate11,$rate12);
        $maxposs = max @possibilityDX;#print "$maxposs";
        $maxposs =~ s/\%//;
        foreach (keys %hashtri) {
          if (($hashtri{$_} == $maxposs.'%') and ($maxposs > 90 )) {
            $DXtripos = $_.'('.$maxposs.'%)';
        ...
        ##
        $chrX   = "ChrX\t$hash4{$chr1}\t$DXtripos"."("."$hashrate{ChrX}".")"."\t$rate1\t$rate2\t$rate3\t$rate4\t$rate5\t$rate6\t$rate7\t$rate8\t$rate9\t$rate10\t$rate11\t$rate12\n";
    }
}
...
print '总计'
  . "\t$hash_all\t\t$rate_M1M1M1\t$rate_M1M1M2\t$rate_M1M1P1\t$rate_M1M2P1\t$rate_P1P1P1\t$rate_P1P1P2\t$rate_P1P1M1\t$rate_P1P2M1\t$rate_MMM\t$rate_MMP\t$rate_PPP\t$rate_PPM\n$header1$chrX";
