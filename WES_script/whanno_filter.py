...
standRmList = ['GeneDetail.refGene','genomicSuperDups','InterVar_automated','InterVar_proof','Otherinfo','Otherinfo1','DP','#CHROM','POS','ID','REF','ALT','INFO','FORMAT','gene_dis','pred_ratio','pred_stats','local_fre','fre_count','DS_AG','DS_AL','DS_DG','DS_DL','local_var','EYE_PANEL','ENDO_PANEL','META_PANEL','NEVR_PANEL','dup_region']
