...
if [ $2 == '1M' ];then 
	...
	cnvkit.py batch $1.dedup.sorted.bam -r /home/tianxl/pipeline/CNV-seq/GDCNV-seq/Xtenref/1M/my_reference_1Mnext500.cnn    -d analyse/ -p 10 
        ...
        cnvkit.py batch $1.dedup.sorted.bam -r  /home/tianxl/pipeline/CNV-seq/GDCNV-seq/Xtenref/100K/my_reference_25K.cnn   -d analyse/ -p 10
	...
	paste "$1".band_gene_v2.xls $1.cnv_anno.txt > $1.band_gene_v2.cnv_anno.xls
        ...
        cd ../ 
        sh /home/tianxl/pipeline/CNV-seq/GDCNV-seq/GDpip_Xten.sh $1 $2 
      fi 
